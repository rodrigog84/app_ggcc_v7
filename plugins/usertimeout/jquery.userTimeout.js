		...
		var modal = function () {
			...
			if (modalUI === 'bootstrap') {
				...
				if (options.timer === true) {
					footer = $('<div class="modal-footer"><button type="button" class="btn btn-primary" data-dismiss="modal">Continuar en  (<span id="countdowntimer">' + seconds + '</span>)</button></div>');
					countDown(seconds);
				} else {
					footer = $('<div class="modal-footer"><button type="button" class="btn btn-primary" data-dismiss="modal">Continuar</button></div>');
				}
				
				logoutBtn = $('<button type="button" class="btn btn-default" id="logoff">Salir</button>');
