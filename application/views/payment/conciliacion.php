      ...
      <form id="basicBootstrapForm"  action="<?php echo base_url();?>payments/conciliacion" method="post">
          <div class="row">
            <div class="col-md-8">
                      ...
                      <div class='col-md-4'>
                        <div class="form-group">
                          <label for="periodo">Estado Conciliaci&oacute;n</label>
                            ...
                            <option value="sc" <?php echo $tipoconciliacion == '' ? 'selected': '';?>>Mostrar Sin Conciliaci&oacute;n</option>
                    ...
                    <?php if(count($movimientos) > 0 ){ ?>
                      ...
                      <?php foreach ($movimientos as $movimiento) { ?>
                       <tr >
                        ...
                        <td>
                            <?php if($movimiento->activo == 1){ ?>
                                <a href="<?php echo base_url(); ?>admins/conciliar_movimiento/<?php echo $movimiento->tipo_movimiento;?>/<?php echo $movimiento->id;?>" data-toggle="tooltip" title="<?php echo is_null($movimiento->fechaconciliacion) ? 'Conciliar' : 'Editar Conciliacion';?>">
                        ...
                        <td>
                          <?php if($movimiento->activo == 1){ ?>
                            <a href="<?php echo base_url(); ?>payments/ver_conciliacion_movimiento/<?php echo $movimiento->tipo_movimiento; ?>/<?php echo $movimiento->id;?>" data-toggle="tooltip" title="Ver Detalle Movimiento"><span class="glyphicon glyphicon-search input-sm"></span></a>
                          <?php } ?>
                        </td>
                        <td>
                          <?php if(strpos($movimiento->glosa,'Protesto') === false && $movimiento->protesto == 0 && $movimiento->tipo_movimiento != 'i'){  // si es protesto no se puede eliminar ?>
                            <a style="display:<?php echo $delete_movimiento; ?>" id="delete-<?php echo $movimiento->id;?>" href="<?php echo base_url();?>admins/delete_movimiento/<?php echo $movimiento->tipo_movimiento;?>/<?php echo $movimiento->id;?>" data-toggle="tooltip" title="Eliminar Movimiento" ><span class="glyphicon glyphicon-trash input-sm"></span></a>
                          <?php } ?>
                        </td>
