                      ...
                      <div class="box-body" >
                        ...
                        <thead>
                          <tr>
                            ...
                            <th>Depreciaci&oacute;n Acumulada</th>
                          </tr>
                        </thead>
                        <tbody>
                          <?php $monto_total = 0; ?>
                          <?php if(count($detalle_cuenta[0]) > 0 ){ ?>
                            <?php foreach ($detalle_cuenta[0] as $detalle) { ?>
                             <tr >
                              ...
                              <td><?php echo "$ ".number_format($detalle->depacum*(-1),0,".",".");?></td>
                            </tr>
                            <?php $monto_total -= $detalle->depacum; ?>
                            <?php } ?>
                          <?php } ?>
                        </tbody>
                        <tfoot>
                          ...
                          <th>Total</th>
                          <th colspan="5">&nbsp;</th>
                          <th><?php echo "$ ".number_format($monto_total+$detalle_cuenta[1]->valor,0,".","."); ?></th>
                          </tr>                          
                        </tfoot>
                        </table>
                        </form>
