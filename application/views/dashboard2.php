        ...
        <section class="content">
          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-xs-6">
              <!-- small box -->
              <div class="small-box <?php echo $datos_dashboard['deudapropiedad'] > 0 ? 'bg-red' : 'bg-green'; ?>">
                <div class="inner">
                  <h4>$<?php echo number_format($datos_dashboard['deudapropiedad'],0,".","."); ?></h4>
                  <p>Saldo Deuda Propiedad</p>                
                </div>
                <div class="icon">
                  <i class="ion <?php echo $datos_dashboard['deudapropiedad'] > 0 ? 'ion-arrow-graph-down-right' : 'ion-arrow-graph-up-right'; ?>"></i>
                </div>
                <a href="<?php echo base_url();?>payments/ver_ggcc" class="small-box-footer">M&aacute;s Informaci&oacute;n <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
            <div class="col-lg-3 col-xs-6">
              <!-- small box -->
          ...
          <?php if($datos_dashboard['level'] == 2){ ?>
          <div class="row">
            <div class="col-lg-3 col-xs-6 ">
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header">
                  <i class="fa fa-bar-chart-o"></i>
                  <h3 class="box-title">Gasto Com&uacute;n Comunidad. &Uacute;ltimos 12 Per&iacute;odos </h3>
                </div>
                <div class="box-body">
