            ...
            <div class="col-md-6">
              <div class="box box-solid ">
                <div class="box-header">
                  <h3 class="box-title">C&oacute;digos para reemplazar en el texto</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                                <ul>
                                  <li><b>{usuario}</b>: Nombre del Copropietario</li>
                                  <li><b>{comunidad}</b>: Nombre de la comunidad emisora del Gasto Com&uacute;n</li>
                                  <li><b>{propiedad}</b>: N&uacute;mero de la propiedad con deuda</li>
                                  <li><b>{periodo}</b>: Per&iacute;odo del Gasto Com&uacute;n Emitido</li>
                                  <li><b>{monto}</b>: Monto de la Deuda (en formato $999.999)</li>
                                  <li><b>{vencimiento}</b>: Fecha de Vencimiento del Gasto Com&uacute;n (en formado dd/mm/aaaa)</li>
                                </ul>
                </div><!-- /.box-body -->
              </div><!-- /.box -->
            </div><!-- /.col (left) -->
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- form start -->
                        <form id="basicBootstrapForm" action="<?php echo base_url(); ?>admins/submit_envio_mail_vencimiento" method="post">
                            <div class="box-body">
                                <div class="row">
                                    ...
                                    <div class='col-md-12'>
                                        <div class="form-group">
                                            ...
                                            <textarea class="textarea" id="txt_mail" name="txt_mail" placeholder="Agrega Texto Aqu&iacute;" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $datos_comunicado['txt_mail']; ?>
                            ...
                            <div class="box-footer">
                                <input type="hidden" name="tipo" id="tipo" value="<?php echo $datos_comunicado['tipo']; ?>">
                                    <button type="submit" class="btn btn-success"><?php echo $datos_comunicado['txt_button']; ?></button>
                                    &nbsp;&nbsp;
                                <a href="<?php echo base_url(); ?>admins/accion_mora" class="btn btn-default">Volver</a>
                            </div>
                        </form>
