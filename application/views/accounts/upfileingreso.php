                  ...
                  <div class="box-body">
                    ...
                    <div class='row'>
                      ...
                      <div class='col-md-6'>
                        ...
                        <center><a href="<?php echo base_url(); ?>uploads/ingresos/<?php echo $this->session->userdata('comunidadid')."/".$cuenta->nombrearchivo;?>" target="_blank" data-toggle="tooltip" title="Abrir Comprobante"><h4 class="glyphicon glyphicon-paperclip"></h4></a></center>
                          <?php } ?>
                      </div>          
                      <?php if($existe){
                        $habilitagasto = $cuenta->habilitagasto == 1 ? 'on' : '';
                      }else{
                        $habilitagasto = '';
                      } ?>         
                      <input type="hidden" name="idingreso" id="idingreso" value="<?php echo $cuenta->id; ?>" >  
                      ...
                      <input type="hidden" name="tipoingreso" id="tipoingreso"  value="<?php echo $existe ? $cuenta->tipoingreso : '';?>">
                      <input type="hidden" name="habilitagasto" id="habilitagasto"  value="<?php echo $habilitagasto; ?>">
                    </div>
