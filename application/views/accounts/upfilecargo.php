                ...
                <form id="basicBootstrapForm" action="<?php echo base_url();?>accounts/submit_otros_cargos" method="post" role="form" enctype="multipart/form-data">
                  <div class="box-body">
                          ...
                          <div class="col-md-6">                      
                            <div class="form-group">
                              <label for="fecdocumento">Fecha Pago</label>
                               <input type="text" class="form-control" name="fecpago" id="fecpago"  readonly value="<?php echo $existe ? $cuenta->fecdocumento : '';?>">
                            </div>                              
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <input type="hidden" name="idcargo" id="idcargo" value="<?php echo $cuenta->id; ?>" >
