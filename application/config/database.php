...
$db['default']['hostname'] = 'tugastocomun.cl';
//$db['default']['port'] = 1433; //'chilefor_admin21'
$db['default']['username'] = 'gasto_ggcc'; //'chilefor_admin21'
$db['default']['password'] = 'hsxubz51vv'; //'^o6_5+TGP8JK';
$db['default']['database'] = 'gasto_ggcc'; // 'chilefor_cf_ctz';
