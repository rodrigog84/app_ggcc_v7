                          ...
                          <?php if(count($detalle_cuenta[0]) > 0 ){ ?>
                            <?php foreach ($detalle_cuenta[0] as $detalle) { ?>
                             <tr >
                              ...
                              <td><?php echo "$ ".number_format($detalle->cuotas_especiales,0,".",".");?></td>
                            </tr>
                            <?php $monto_cobros += $detalle->cuotas_especiales; ?>
                            <?php } ?>
                          <?php } ?>
                        </tbody>
                        <tfoot>
                          ...
                          <th>Subtotal</th>
                          <th colspan="2">&nbsp;</th>
                          <th><?php echo "$ ".number_format($monto_cobros,0,".","."); ?></th>
                          </tr>
                          <tr>
                          ...
                          <th>Total</th>
                          <th colspan="2">&nbsp;</th>
                          <th><?php echo "$ ".number_format($monto_cobros+$detalle_cuenta[1]->valor,0,".","."); ?></th>
                          </tr>                                                    
                        </tfoot>
                        </table>
                        </form>
