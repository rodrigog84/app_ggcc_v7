          ...
          <div class="row">
            <div class="col-md-12">
              <div class="box box-primary">
                ...
                <!-- form start -->
                <form id="basicBootstrapForm" action="<?php echo base_url();?>admins/submit_bodega" id="basicBootstrapForm" method="post">
                  <div class="box-body">
                    <div class='row'>
                      <div class='col-md-6'>
                      ...
                      <div class='col-md-6'>
                        <div class="form-group">
                            <label for="nombre">Nombre Bodega</label>  
                             <input type="text" id="nombre" name="nombre" class="form-control" placeholder="Ingrese Nombre Bodega" value="<?php echo $datos_form['nombre']; ?>">
                        </div>
                      </div> 
                      <div class='col-md-6'>
                        <div class="form-group">
                  ...
                  <input type="hidden" name="idbodega" value="<?php echo $datos_form['idbodega']; ?>" >
    ...
    $('#basicBootstrapForm').formValidation({
        ...
        fields: {
            ...
            nombre: {
                ...
                validators: {
                    notEmpty: {
                        message: 'Nombre Bodega es requerido'
                    }
                }
            },
